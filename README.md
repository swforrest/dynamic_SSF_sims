...
The code in this repository accompanies a paper titled 'Simulating animal movement trajectories from temporally dynamic step selection functions'.
...
Script 7 - DynSSF_Walkthrough_Harmonics_and_selection_surfaces.Rmd
