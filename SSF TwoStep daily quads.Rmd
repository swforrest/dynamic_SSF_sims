...
naive_raster_daily_2harms_quads_w_herby_wet <- naive_pred_stack
boyce_naive_raster_daily_2harms_quads_w_herby_wet <- boyce_naive_list

# terra::writeRaster(rast(naive_pred_stack), "mapping/naive_pred_stack_daily_2harms_ndvi2_canopy2_herby_wet_20230524.tif")
