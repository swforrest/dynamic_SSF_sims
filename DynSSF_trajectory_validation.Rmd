...
subtitle: Compare simulated trajectories to the observed buffalo trajectories using summary statistics. The first summary statistics are calculated for each hour of the day (i.e. mean step lengths, mean values of covariates), and the latter set summarises the full trajectory.
editor_options:
