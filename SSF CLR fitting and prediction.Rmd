...
buffalo_CLR <- buffalo_data %>% 
  mutate(id_num = as.numeric(factor(id)), 
         ...
         yday_s5 = sin(10*pi*yday/365),
         yday_s6 = sin(12*pi*yday/365),
         
         yday_c1 = cos(2*pi*yday/365),
         yday_c2 = cos(4*pi*yday/365),
         yday_c3 = cos(6*pi*yday/365),
         yday_c4 = cos(8*pi*yday/365),
         yday_c5 = cos(10*pi*yday/365),
         yday_c6 = cos(12*pi*yday/365)
...
# fourier(buffalo_CLR_year$ndvi_scaled[,1], K = 1)
...
for(i in 1:10) print(AIC(clogit_model_list[[i]]))
...
fourier_expr <- 
  ...
  (-0.076*sin(2*pi*x/365))+
  (0.16*sin(4*pi*x/365))+
  (0.22*sin(6*pi*x/365))+
  (-0.007*sin(8*pi*x/365))+
  (0.018*sin(10*pi*x/365))+
  (0.036*sin(12*pi*x/365))+
  
  (-0.014*cos(2*pi*x/365))+
  (0.12*cos(4*pi*x/365))+
  (0.097*cos(6*pi*x/365))+
  (-0.05*cos(8*pi*x/365))+
  (0.15*cos(10*pi*x/365))+
  (-0.09*cos(12*pi*x/365))
...
fourier_expr <- 
  ...
  (0.098*sin(2*pi*x/365))+
  (-0.079*sin(4*pi*x/365))+
  (-0.067*sin(6*pi*x/365))+
  (-0.057*sin(8*pi*x/365))+
  (-0.008*sin(10*pi*x/365))+
  (0.0067*sin(12*pi*x/365))+
  
  (0.015*cos(2*pi*x/365))+
  (0.047*cos(4*pi*x/365))+
  (-0.014*cos(6*pi*x/365))+
  (0.010*cos(8*pi*x/365))+
  (-0.16*cos(10*pi*x/365))+
  (-0.001*cos(12*pi*x/365))
